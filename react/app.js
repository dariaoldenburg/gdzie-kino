...
import { RemindPasswordPage } from './components/remind.password.page';
...
ReactDOM.render(
      ...
      <PersistGate loading={null} persistor={persistor}>
        <Router>
          <span>
            ...
            <AnonymousRoute exact path="/rejestracja" component={ RegisterPage } />
            <AnonymousRoute exact path="/przypomnienie-hasla" component={ RemindPasswordPage } />
            <Footer />
            <Modals />
          </span>
        </Router>
  ...
  document.getElementById('cinema-tracker-root')
);
